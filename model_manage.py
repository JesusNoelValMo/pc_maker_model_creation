...
def Create_New_Transformers(df):
    ...
    joblib.dump(size_scaler_low, "Transformers/size_scaler_low.pkl")
    joblib.dump(Ram_scaler_low, "Transformers/Ram_scaler_low.pkl")
    ...
    joblib.dump(OHE_processor_low, "Transformers/OHE_processor_low.pkl")
    ...
    joblib.dump(OHE_Windows_low, "Transformers/OHE_Windows_low.pkl")
